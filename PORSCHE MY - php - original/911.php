...
// Fetch 911 model data from the database
$query = "SELECT model_name AS model, power, acceleration, top_speed, price, image_path FROM porsche_models WHERE category = '911'";
$result = $conn->query($query);

// Store model data in an array for JavaScript
$models = [];
...
<body>
    ...
    <script>
        // Pass PHP model data to JavaScript
