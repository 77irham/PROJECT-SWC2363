...
// Fetch data from the database for the 'Macan' category
$query = "SELECT model_name AS model, power, acceleration, top_speed, price, image_path FROM porsche_models WHERE category = 'Macan'";
