...
// Fetch data for Taycan models from the database
$query = "SELECT model_name, power, acceleration, top_speed, price, image_path FROM porsche_models WHERE category = 'Taycan'";
$result = $conn->query($query);

// Store the Taycan model data in an array for easy access in JavaScript
$models = [];
...
<head>
    ...
    <title>Porsche MY - Taycan Models</title>
